...
void decoder()
{
    static float trellis[8][message_length] = { 0 };
    ...
    trellis[0][0] = sqrt((rx_symbol[0][0] - 1) * (rx_symbol[0][0] - 1) + rx_symbol[0][1] * rx_symbol[0][1]) + sqrt((rx_symbol[1][0] - 1) * (rx_symbol[1][0] - 1) + rx_symbol[1][1] * rx_symbol[1][1]);
    trellis[1][0] = sqrt((rx_symbol[0][0] + 1) * (rx_symbol[0][0] + 1) + rx_symbol[0][1] * rx_symbol[0][1]) + sqrt((rx_symbol[1][0] + 1) * (rx_symbol[1][0] + 1) + rx_symbol[1][1] * rx_symbol[1][1]);
    for (j = 2; j < 8; j++)
    {
        trellis[j][0] = 25535;
        trellis[j][1] = 25535;
    }
    trellis[0][1] = sqrt((rx_symbol[2][0] - 1) * (rx_symbol[2][0] - 1) + rx_symbol[2][1] * rx_symbol[2][1]) + sqrt((rx_symbol[3][0] - 1) * (rx_symbol[3][0] - 1) + rx_symbol[3][1] * rx_symbol[3][1]);
    trellis[1][1] = sqrt((rx_symbol[2][0] + 1) * (rx_symbol[2][0] + 1) + rx_symbol[2][1] * rx_symbol[2][1]) + sqrt((rx_symbol[3][0] + 1) * (rx_symbol[3][0] + 1) + rx_symbol[3][1] * rx_symbol[3][1]);
    trellis[4][1] = sqrt((rx_symbol[2][0] + 1) * (rx_symbol[2][0] + 1) + rx_symbol[2][1] * rx_symbol[2][1]) + sqrt((rx_symbol[3][0] - 1) * (rx_symbol[3][0] - 1) + rx_symbol[3][1] * rx_symbol[3][1]);
    trellis[5][1] = sqrt((rx_symbol[2][0] - 1) * (rx_symbol[2][0] - 1) + rx_symbol[2][1] * rx_symbol[2][1]) + sqrt((rx_symbol[3][0] + 1) * (rx_symbol[3][0] + 1) + rx_symbol[3][1] * rx_symbol[3][1]);

    for (i = 2; i < message_length - 2; i++)
    {
        trellis[0][i] = sqrt((rx_symbol[2 * i][0] - 1) * (rx_symbol[2 * i][0] - 1) + rx_symbol[2 * i][1] * rx_symbol[2 * i][1]) + sqrt((rx_symbol[2 * i + 1][0] - 1) * (rx_symbol[2 * i + 1][0] - 1) + rx_symbol[2 * i + 1][1] * rx_symbol[2 * i + 1][1]);
        trellis[1][i] = sqrt((rx_symbol[2 * i][0] + 1) * (rx_symbol[2 * i][0] + 1) + rx_symbol[2 * i][1] * rx_symbol[2 * i][1]) + sqrt((rx_symbol[2 * i + 1][0] + 1) * (rx_symbol[2 * i + 1][0] + 1) + rx_symbol[2 * i + 1][1] * rx_symbol[2 * i + 1][1]);
        trellis[2][i] = sqrt((rx_symbol[2 * i][0] + 1) * (rx_symbol[2 * i][0] + 1) + rx_symbol[2 * i][1] * rx_symbol[2 * i][1]) + sqrt((rx_symbol[2 * i + 1][0] + 1) * (rx_symbol[2 * i + 1][0] + 1) + rx_symbol[2 * i + 1][1] * rx_symbol[2 * i + 1][1]);
        trellis[3][i] = sqrt((rx_symbol[2 * i][0] - 1) * (rx_symbol[2 * i][0] - 1) + rx_symbol[2 * i][1] * rx_symbol[2 * i][1]) + sqrt((rx_symbol[2 * i + 1][0] - 1) * (rx_symbol[2 * i + 1][0] - 1) + rx_symbol[2 * i + 1][1] * rx_symbol[2 * i + 1][1]);
        trellis[4][i] = sqrt((rx_symbol[2 * i][0] + 1) * (rx_symbol[2 * i][0] + 1) + rx_symbol[2 * i][1] * rx_symbol[2 * i][1]) + sqrt((rx_symbol[2 * i + 1][0] - 1) * (rx_symbol[2 * i + 1][0] - 1) + rx_symbol[2 * i + 1][1] * rx_symbol[2 * i + 1][1]);
        trellis[5][i] = sqrt((rx_symbol[2 * i][0] - 1) * (rx_symbol[2 * i][0] - 1) + rx_symbol[2 * i][1] * rx_symbol[2 * i][1]) + sqrt((rx_symbol[2 * i + 1][0] + 1) * (rx_symbol[2 * i + 1][0] + 1) + rx_symbol[2 * i + 1][1] * rx_symbol[2 * i + 1][1]);
        trellis[6][i] = sqrt((rx_symbol[2 * i][0] - 1) * (rx_symbol[2 * i][0] - 1) + rx_symbol[2 * i][1] * rx_symbol[2 * i][1]) + sqrt((rx_symbol[2 * i + 1][0] + 1) * (rx_symbol[2 * i + 1][0] + 1) + rx_symbol[2 * i + 1][1] * rx_symbol[2 * i + 1][1]);
        trellis[7][i] = sqrt((rx_symbol[2 * i][0] + 1) * (rx_symbol[2 * i][0] + 1) + rx_symbol[2 * i][1] * rx_symbol[2 * i][1]) + sqrt((rx_symbol[2 * i + 1][0] - 1) * (rx_symbol[2 * i + 1][0] - 1) + rx_symbol[2 * i + 1][1] * rx_symbol[2 * i + 1][1]);
    }
    trellis[0][i] = sqrt((rx_symbol[2 * i][0] - 1) * (rx_symbol[2 * i][0] - 1) + rx_symbol[2 * i][1] * rx_symbol[2 * i][1]) + sqrt((rx_symbol[2 * i + 1][0] - 1) * (rx_symbol[2 * i + 1][0] - 1) + rx_symbol[2 * i + 1][1] * rx_symbol[2 * i + 1][1]);
    trellis[1][i] = 25535;
    trellis[2][i] = sqrt((rx_symbol[2 * i][0] + 1) * (rx_symbol[2 * i][0] + 1) + rx_symbol[2 * i][1] * rx_symbol[2 * i][1]) + sqrt((rx_symbol[2 * i + 1][0] + 1) * (rx_symbol[2 * i + 1][0] + 1) + rx_symbol[2 * i + 1][1] * rx_symbol[2 * i + 1][1]);
